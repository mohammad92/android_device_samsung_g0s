...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/g0s/prebuilt/Image
TARGET_PREBUILT_DTB := device/samsung/g0s/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/g0s/prebuilt/recovery_dtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPUG08A002"
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB) --dtb_offset $(BOARD_DTB_OFFSET)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/g0s/bootimg.mk
